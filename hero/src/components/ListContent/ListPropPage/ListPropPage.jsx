...
class Com extends Component {
    ...
    onChange(e) {
      ...
      onchanged(e) {
        if(e.target.value !== '') {
            api.requestAllTuBiaoNameData(e.target.value)
            .then(data => {
            this.setState({
                allList:data.data,
                activeIn: 2
            ...
            api.requestAllTuBiaoData(pageCode)
            .then(data => {
                this.setState({
                    allList:data.data,
                    activeIn: 1
    ...
    render () {
        ...
        let named = this.props.match.params.name
            named = '4'
        if(named === '4' && this.state.activeIn === 1) {
            html = <Pagination showQuickJumper  defaultCurrent={1} total={70} onChange={this.onChange.bind(this)} />
        }
        else {
             html = ''
        }
        return (
            <div>
                <div className="navigation">您现在的位置：英雄联盟 > 道具</div>
                    ...
                    <div className='right'>
                        <div className='right_nav'>
                            <div className='search'>
                               关键字: <input type="text" defaultValue={named === '4' ? '' : named} onChange={this.onchanged.bind(this)}/>
