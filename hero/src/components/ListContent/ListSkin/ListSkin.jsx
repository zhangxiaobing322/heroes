...
class Com extends Component {
    ...
    onChange(e) {
      ...
      onchanged(e) {
        if(e.target.value !== '') {
            api.requestAllSkinNameData(e.target.value)
            .then(data => {
            this.setState({
                allList:data.data,
                activeIn: 2
            ...
            api.requestAllSkinData(pageCode)
            .then(data => {
                this.setState({
                    allList:data.data,
                    activeIn: 1
    ...
    render () {
        ...
        named = '3'
        if(named === '3' && this.state.activeIn === 1) {
            html = <Pagination showQuickJumper  defaultCurrent={1} total={600} onChange={this.onChange.bind(this)} />
        }
        else {
             html = ''
        }
        return (
            <div>
                <div className="navigation">您现在的位置：英雄联盟 > 皮肤</div>
                    ...
                    <div className='right'>
                        <div className='right_nav'>
                            <div className='search'>
                               关键字: <input type="text" defaultValue={named === '3' ? '' : named} onChange={this.onchanged.bind(this)}/>
